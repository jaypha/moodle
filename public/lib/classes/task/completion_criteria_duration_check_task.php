...
/**
 * Scheduled task to check for duration completion criteria.
 *
 * @package   core
 ...
 */
class completion_criteria_duration_check_task extends scheduled_task {
    use completion_criteria_check_trait;

    #[\Override]
    public function get_name() {
        return get_string('taskcompletioncriteriadurationcheck', 'admin');
    }

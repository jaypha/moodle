...
class completion_criteria_course extends completion_criteria {
     ...
     * @param int|null $userid Limit the search to a particualr user.
     * @param int|null $courseinstance Limit the search to the specified Course instance.
     */
    public function cron(
        ?int $timefrom = null,
        ?int $courseid = null,
        ?int $userid = null,
        ?int $courseinstance = null
    ) {
        global $DB;
        ...
        if (!is_null($courseinstance)) {
            $sql .= " AND cr.courseinstance = :courseinstance";
            $params['courseinstance'] = $courseinstance;
        }

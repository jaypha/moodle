...
class task_stat extends base {
     ...
     * @return string
     */
    protected static function round(float $value, $row, int $precision = 0): string {
        return sprintf('%.*f', $precision, round($value, $precision));
    }
}
